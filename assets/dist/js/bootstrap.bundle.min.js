...
function livro_joao(){
	const livro2 = document.getElementById("escolha_joao").value;
	fetch('https://bible-api.com/' + livro2)
	  .then(response => response.json())	
	  .then(data => paragrafo1(data));
}

function livro_romanos(){
	const livro1 = document.getElementById("escolha_romanos").value;
	fetch('https://bible-api.com/' + livro1)
	  .then(response => response.json())
	  .then(data => paragrafo2(data));
}

function paragrafo1(data){
	console.log(data);
	document.getElementById("p_01").innerHTML = data.text;
}

function paragrafo2(data){
	console.log(data);
	document.getElementById("p_02").innerHTML = data.text;
}
...
function iniciar(){
	document.getElementById('div_joao').style.visibility = 'hidden';
	document.getElementById('div_romanos').style.visibility = 'hidden';
}

function escolha_livro(){
switch(livro.value) {
    case "joao":
        document.getElementById("div_joao").style.visibility = 'visible';
        document.getElementById("div_romanos").style.visibility = 'hidden';
      break;
    case "romanos":
    	document.getElementById("div_romanos").style.visibility = 'visible';
      	document.getElementById("div_joao").style.visibility = 'hidden';
      break;
}
}
